...
export default class CustomTask {
  ...
  async downloadFile() {
   ...
   const filePath = path.resolve(process.cwd(), ".artifacts/downloads", await download.suggestedFilename());
  ...
  async uploadFile() {
    ...
    await fileInput.setInputFiles("testAssets/testData/downloadtxt/info.txt");
  }
